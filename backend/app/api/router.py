...
from app.api import alerts, dashboard, devices, dns, ping, profiles, schedule, speed, speedtest_endpoint, tests, traceroute, wifi, ws
...
api_router.include_router(speedtest_endpoint.router)
